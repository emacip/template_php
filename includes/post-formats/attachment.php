<!-- ## post start ## -->
<article id="post-<?php the_ID(); ?>" <?php post_class( array('post', 'attachment') ); ?>>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10 col-xs-12 col-sm-offset-1 entry-gallery">
                <?php
                    inafx_attachment();
                ?>
            </div>
            <div class="col-sm-10 col-xs-12 col-sm-offset-1 post-container">
                ...
                <div class="row post-entry">
                    ...
                    <?php get_template_part( 'includes/post-formats/post-edit' ); ?>
