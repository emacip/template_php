...
?>   
    <p>
        <label for="<?php echo $widget->get_field_id('dw_include'); ?>"><?php echo theme_locals( 'dw_show_widget_for' ); ?></label>
        <select name="<?php echo $widget->get_field_name('dw_logged'); ?>" id="<?php echo $widget->get_field_id('dw_logged'); ?>" class="widefat">
            <option value=""><?php echo theme_locals( 'dw_everyone' ); ?></option>
            <option value="out" <?php echo selected( $instance['dw_logged'], 'out' ) ?>><?php echo theme_locals( 'dw_loggedout_users' ); ?></option>
            <option value="in" <?php echo selected( $instance['dw_logged'], 'in' ) ?>><?php echo theme_locals( 'dw_loggedin_users' ); ?></option>
        </select>
    </p>

     <p>
    	<select name="<?php echo $widget->get_field_name('dw_include'); ?>" id="<?php echo $widget->get_field_id('dw_include'); ?>" class="widefat">
            <option value="0"><?php echo theme_locals( 'dw_hide_on_checked' ); ?></option> 
            <option value="1" <?php echo selected( $instance['dw_include'], 1 ) ?>><?php echo theme_locals( 'dw_show_on_checked' ); ?></option>
        </select>
    </p>    

<div style="height:150px; overflow:auto; border:1px solid #dfdfdf; padding:5px; margin-bottom:5px;">
    <h4 class="dw_toggle" style="cursor:pointer;margin-top:0;"><?php echo theme_locals( 'dw_toggle_misc' ); ?> +/-</h4>
    ...
    ?>
        ...
        <label for="<?php echo $widget->get_field_id('page-'. $key); ?>"><?php echo $label .' '. theme_locals( 'dw_page' ); ?></label></p>
    <?php } ?>
    </div>
    
    <h4 class="dw_toggle" style="cursor:pointer;"><?php echo theme_locals( 'dw_toggle_pages' ); ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php echo theme_locals( 'dw_toggle_custom_post_types' ); ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php echo theme_locals( 'dw_toggle_custom_post_archives' ); ?> +/-</h4>
    <div class="dw_collapse">
    <?php foreach ( $this->cposts as $post_key => $custom_post ) {
    ...
    ?>
        ...
        <label for="<?php echo $widget->get_field_id('type-'. $post_key .'-archive'); ?>"><?php echo stripslashes($custom_post->labels->name) ?> <?php echo theme_locals( 'dw_archive' ); ?></label></p>
    <?php } ?>
    </div>
    <?php } ?>
    
    <h4 class="dw_toggle" style="cursor:pointer;"><?php echo theme_locals( 'dw_toggle_categories' ); ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php echo theme_locals( 'dw_toggle_taxonomies' ); ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php echo theme_locals( 'dw_toggle_languages' ); ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <p><label for="<?php echo $widget->get_field_id('other_ids'); ?>"><?php echo theme_locals( 'dw_post_ids_list' ); ?>:</label>
...
<?php
    ...
    function page_types(){
        $page_types = array(
            'front'     => theme_locals( 'dw_page_type_front' ), 
            'home'      => theme_locals( 'dw_page_type_blog' ),
            'archive'   => theme_locals( 'dw_page_type_archives' ),
            'single'    => theme_locals( 'dw_page_type_single_post' ),
            '404'       => theme_locals( 'dw_page_type_404' ),
            'search'    => theme_locals( 'dw_page_type_search' ),
        );
