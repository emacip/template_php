 ...
 *
 * Modified By INA Brains according to WordPress Guidelines
 * Implemented wp_filesystem for file handling
 * Removed encoding based code
 */
class lessc {
	...
	protected function lib_unquotextract($value) {
